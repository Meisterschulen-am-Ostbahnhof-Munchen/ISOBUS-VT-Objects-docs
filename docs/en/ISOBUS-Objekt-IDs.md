...
| SoftKey | 5000 | SoftKey\_%ld | 5 | [ID 5 - Key (Soft Key) - ISO 11783-6 - B.6](isobus-objects/ID-05---Key-%28Soft-Key%29---ISO-11783-6---B.6.md) | [Wiki](https://isobus-studio.com/isobus-wiki/isobus-objectpool-objects/key) |
