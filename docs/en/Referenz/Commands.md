...
| **F.20** | Change Background Color| ECU->VT | A7 | **Yes** | 2 |
...
| **F.38** | Change Attributes | ECU->VT | AF | **Yes** | 2 |
...
| **F.58** | GetAttributeValue | ECU->VT | B9 | No | 4 |
| **F.60** | Select Color Map/Palette | ECU->VT | BA | **Yes** | 4 |
| **F.62** | Execute Extended Macro | ECU->VT | B.C. | **Yes** | 5 |
