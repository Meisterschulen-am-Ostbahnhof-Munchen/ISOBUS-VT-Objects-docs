...
| [6] | **Options**                     | Bitmask        | 1            | 0 – 63           | 11          | Bit 0: Latchable (0=Buttoning, 1=Hanging)<br>Bit 1: State (only for Latchable: 0=Released, 1=Pressed)<br>Bit 2: Suppress Border (1=No border drawn)<br>Bit 3: Transparent (1=Background transparent)<br>Bit 4: Disabled (1=Disabled/Grayed out)<br>Bit 5: No Border (1=Border area omitted, Button Face = Button Area). |
