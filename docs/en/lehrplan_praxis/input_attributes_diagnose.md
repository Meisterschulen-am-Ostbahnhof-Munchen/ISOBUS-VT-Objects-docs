...
**Framework Curriculum Category:** Part I LE 2.2 (40 teaching units) | Part II LE 1.1 & 1.3
**Relevance:** Input processing, button events, and diagnostics of HMI communication errors.
...
Canal bus messages:** Analysis of VT-to-ECU and ECU-to-VT messages using CAN trace tools.